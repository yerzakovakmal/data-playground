...
Below are the key analytical visualization plots generated by our Jupyter Notebook pipeline (located in the [`reports/`](file:///Users/akmalyerzakov/projects/github/data-playground/superstore-analysis/reports/) directory):
...
Detailed SQL analysis scripts in [`sql/`](file:///Users/akmalyerzakov/projects/github/data-playground/superstore-analysis/sql/) were executed on the normalized PostgreSQL database. Below are the core findings:
...
```bash
cd /Users/akmalyerzakov/projects/github/data-playground/superstore-analysis
